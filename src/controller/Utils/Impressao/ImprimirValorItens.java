 ...
 */
package controller.Utils.Impressao;
 ...
 */
public class ImprimirValorItens {
    //System.getProperty("user.name")
    private String FILE = "C:\\Users\\"+System.getProperty("user.name")+"\\Documents\\Mensal ";
    ...
    public void imprimirValorVendido(String titlo,String data, String valorTotal, List<List<String>> compras) throws FileNotFoundException, DocumentException{
        ...
        Document document = new Document();
            ...
            preface.add(new Phrase(titlo, subFont));
            preface.add(new Paragraph("\n"));          
            
            preface.add(new Paragraph("\n"));          
            preface.add(new Phrase("Data:", smallBold)); preface.add(" "+data);
            ...
            preface.add(new Paragraph("\n"));          
            preface.add(new Phrase("Valor total:", smallBold)); preface.add(" "+valorTotal +" Kz");
